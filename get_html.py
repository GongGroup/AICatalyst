...
def get_wos_database(config_file, htmls):
    """
    According to the setting in config.json, crawler the WOS database and write the results to htmls/ directory,
    one html represents one page in WOS.

    Args:
        config_file: represent the config.json path
        htmls: represent the output path
    """
...
if __name__ == '__main__':
    get_wos_database(config_file="config.json", htmls="htmls")
